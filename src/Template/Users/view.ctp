...
<div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav" style="margin-left:0;">
                ...
                <li>
                 <a href="/posv2/users/edit/<?= h($user->id)?>"><i class="fa fa-trash" style="margin-right: 10px; margin-left: 5px" aria-hidden="true"> </i> <span>Edit Account</span> </a>
                </li>
                <li>
                    <a href="/posv2/Users/delete/<?= h($user->id)?>" onclick="return confirm(
                                               'Are you sure you wish to delete user # <?= h($user->id)?>'
                                           );"><i class="fa fa-list" style="margin-right: 10px; margin-left: 5px" aria-hidden="true"> </i> <span>Delete</span> </a>
                </li>
                <li>
